...
!function(a) {
    a.fn.bootstrapValidator.i18n=a.extend(!0, a.fn.bootstrapValidator.i18n, {
        ...
        , "between": {
            "default": "Si prega di inserire un valore tra %s e %s", "notInclusive": "Si prega di scegliere rigorosamente un valore tra %s e %s"
        }
        , "callback": {
            "default": "Si prega di inserire un valore valido"
        }
        , "choice": {
            "default": "Si prega di inserire un valore valido", "less": "Si prega di scegliere come minimo l'opzione %s", "more": "Si prega di scegliere al massimo l'opzione %s", "between": "Si prega di scegliere l'opzione tra %s e %s"
        }
        , "creditCard": {
        ...
        , "greaterThan": {
            "default": "Si prega di inserire un numero maggiore o uguale a %s", "notInclusive": "Si prega di inserire un numero maggiore di %s"
        }
        , "grid": {
        ...
        , "iban": {
            "default":"Si prega di inserire un numero IBAN valido", "countryNotSupported":"Il codice del paese %s non e supportato", "country":"Si prega di inserire un numero IBAN valido in %s", "countries": {
        ...
        , "id": {
            "default":"Si prega di inserire un numero di identificazione valido", "countryNotSupported":"Il codice nazione %s non e supportato", "country":"Si prega di inserire un numero di identificazione %s valido", "countries": {
                "BA": "Bosnia-Erzegovina", "BG": "Bulgaria", "BR": "Brasiliano", "CH": "Svizzero", "CL": "Cileno", "CZ": "Ceco", "DK": "Danese", "EE": "Estonian", "ES": "Spagnolo", "FI": "Finlandese", "HR": "Croato", "IE": "Irlandese", "IS": "Islandese", "LT": "Lituano", "LV": "Lettone", "ME": "Montenegro", "MK": "Macedone", "NL": "Olandese", "RO": "Rumeno", "RS": "Serbo", "SE": "Svedese", "SI": "Sloveno", "SK": "Slovacco", "SM": "San Marino", "ZA": "Sud Africano"
            }
        }
        , "identical": {
        ...
        , "ip": {
            "default": "Please enter a valid IP address", "ipv4": "Si prega di inserire un indirizzo IPv4 valido", "ipv6": "Si prega di inserire un indirizzo IPv6 valido"
        }
        , "isbn": {
        ...
        , "lessThan": {
            "default": "Si prega di inserire un valore minore o uguale a %s", "notInclusive": "Si prega di inserire un valore minore di %s"
        }
        , "mac": {
        ...
        , "phone": {
            "default":"Si prega di inserire un numero di telefono valido", "countryNotSupported":"Il codice nazione %s non e supportato", "country":"Si prega di inserire un numero di telefono valido in %s", "countries": {
                "BR": "Brasile", "ES": "Spagna", "FR": "Francia", "GB": "Regno Unito", "MA": "Marocco", "PK": "Pakistan", "US": "Stati Uniti d'America"
            }
        }
        , "regexp": {
        ...
        , "stringCase": {
            "default": "Si prega di inserire solo caratteri minuscoli", "upper": "Si prega di inserire solo caratteri maiuscoli"
        }
        , "stringLength": {
            "default": "Si prega di inserire un valore con lunghezza valida", "less": "Si prega di inserire meno di %s caratteri", "more": "Si prega di inserire piu di %s caratteri", "between": "Si prega di inserire un numero di caratteri compreso tra  %s e %s"
        }
        , "uri": {
            "default": "Si prega di inserire un URI valido"
        }
        , "uuid": {
            "default": "Si prega di inserire un numero UUID valido", "version": "Si prega di inserire un numero di versione UUID %s valido"
        }
        , "vat": {
            "default":"Si prega di inserire un valore di IVA valido", "countryNotSupported":"Il codice nazione %s non e supportato", "country":"Si prega di inserire un valore di IVA valido per %s", "countries": {
        ...
        , "zipCode": {
            "default":"Si prega di inserire un CAP valido", "countryNotSupported":"Il codice nazione %s non e supportato", "country":"Si prega di inserire un valido  %s", "countries": {
                "BR": "Codice postale Brasiliano", "CA": "Codice postale Canadese", "DK": "Codice postale Danese", "GB": "Codice postale del Regno Unito", "IT": "Codice postale Italiano", "MA": "Codice postale Marocco", "NL": "Codice postale Olandese", "SE": "Codice postale Svizzero", "SG": "Codice postale di Singapore", "US": "Codice postale US"
            }
        }
    }
    )
