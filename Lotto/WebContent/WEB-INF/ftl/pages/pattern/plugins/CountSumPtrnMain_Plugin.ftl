		...
		<script type="text/javascript">
			...
			function setChart() {
				...
				$.ajax({
					type: "POST",
					url: "${APP_ROOT}/pattern/countsumptrndatas.do",
					dataType: "json",
					...
					success: function(result){
						...
						if (result.status == "success") {
							...
							for ( var i = 0 ; i < result.datas.length ; i++) {								
								...
								data.push(result.datas[i].count_sum);
						  			...
						  			//backgroundColor.push('#e8c695'); // 살색
						  			//backgroundColor.push('#e595e8'); // 보라색
							}
