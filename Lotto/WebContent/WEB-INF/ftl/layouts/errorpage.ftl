...
<html>
	...
	<div class="error_wrap">
		<div class="error_header e02">
			<h1><img src="/images/orange/ci.gif" alt="" /></h1>
		</div>
		<div class="error_point">
			<p class="error_messages"><img src="/images/common/error_messages02.png" alt="페이지를 찾을 수 없습니다. 서비스 이용에 불편을 드려 죄송합니다." /></p>
		</div>
		<div class="error_footer">
			
			<p>			
				<span><a href="/index.do"><img src="/images/common/error_btn_main.gif" alt="메인으로 가기" /></a></span>
			</p>
		</div>
	</div>
	-->
					...
					<div class="row">
						<div class="col-sm-16">
							<div class="text-center error-box">
								<h1 class="error-text tada animated"><i class="fa fa-times-circle text-danger error-icon-shadow"></i> Page not found.</h1>
								<h2 class="font-xl"><strong>요청하신 페이지를 찾을 수 없습니다.</strong></h2>
								<br />
